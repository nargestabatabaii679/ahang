  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      for (let i = 0; i < bars; i++) {
        ...
        if (lit) {
          grad.addColorStop(0, "#f3cd8a");
          grad.addColorStop(0.5, "#e9ae49");
          grad.addColorStop(1, "#e76a5a");
        } else {
          grad.addColorStop(0, "rgba(167,159,190,0.35)");
          grad.addColorStop(1, "rgba(167,159,190,0.12)");
        }
        ctx.fillStyle = grad;
